...
export const getStaticProps:GetStaticProps<StudiesProps> = async () => {
    ...
    const studies = await prisma.study.findMany({  where: { pilar: 'ART' } })
...
const ArtStudies:React.FC<InferGetStaticPropsType<typeof getStaticProps>> = ({ studies }) => {

    return (
        <SmallBasicLayout
            color="primary"
            title="Art Knowledges"
