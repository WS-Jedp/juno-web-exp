...
export const getStaticProps:GetStaticProps<IdeasProps> = async () => {
    ...
    const ideas = await prisma.idea.findMany({ where: { category: 'ESSAY' } })
...
const EssayIdeas:React.FC<InferGetStaticPropsType<typeof getStaticProps>> = ({ ideas }) => {
